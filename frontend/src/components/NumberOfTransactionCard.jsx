            ...
            <div>
                <div className="bg-gray-200 dark:bg-gray-800 shadow-lg rounded-lg p-4 mb-4 min-w-44 min-h-44 flex flex-col justify-evenly ">
                    ...
                    <div className='flex flex-col justify-evenly items-start mt-2'>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Total Transactions: <span className='text-lg font-semibold text-black dark:text-white'>{totalTransactions}</span></p>
                        <p className="text-gray-600 dark:text-gray-400">Today's Transactions: <span className='text-lg font-semibold text-black dark:text-white'>{todayTransactions}</span></p>
                    </div>
                </div>
            </div>
        </>
